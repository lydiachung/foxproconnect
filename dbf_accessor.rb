...
s_url = %Q{jdbc:odbc:Driver={#{h_db_config["driver_name"]}};
  SourceType=DBF;SourceDB=#{h_db_config["dbf_folder"]};}
puts s_url
o_conn = DriverManager.getConnection(s_url, "", "")


# insert
c_sql = %Q{insert into custprop (scope, userid, property, value, memovalue, lock, type) values ('test1','test2','test3','test4','test5','test6','test7')}
puts c_sql
